...
/// <summary>
/// Base for any persistence-identity-bearing object. Equality is by Id, not
/// by reference or value — two Entity instances with the same Id are the
/// same entity even if their state has drifted.
/// </summary>
