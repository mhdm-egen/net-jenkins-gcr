...
public static class AspireAppsEndpoints
{
    public static IEndpointRouteBuilder MapAspireAppEndpoints(this IEndpointRouteBuilder app)
    {
        ...
        {
            var cmd = new CreateAspireApplicationCommand(body.Name, body.Description, body.AppHostPath, body.KubeContext, body.Namespace);
        ...
        {
            var cmd = new UpdateAspireApplicationCommand(id, body.Name, body.Description, body.AppHostPath, body.KubeContext, body.Namespace);
